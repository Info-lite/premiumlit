...
### 授業予定
  ...
  8. [プレゼンテーション１（意義、目的、スライドの内容、構成、PowerPointの概要）](../../powerpoint/01/index.html)
  9. [プレゼンテーション２（デザイン、文字の入力、表・画像・図・リンクの挿入）](../../powerpoint/02/index.html)
  10. [プレゼンテーション３（画面切り替え、アニメーション、スライドショー）](../../powerpoint/03/index.html)
  11. [プレゼンテーション４（スライド・配布資料の作成、口頭・身体表現の効果）](../../powerpoint/04/index.html)
  12. [プレゼンテーション５（発表会）](../../powerpoint/05/index.html)
...
--------------------
  ...
  1.  [スタート] をクリックします
  2.  [すべてのプログラム] - [Microsoft Office] - [Word 2016] をクリックします
