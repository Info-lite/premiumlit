...
画面切り替えとは、次のスライドに移る際のアニメーション効果のことです。

#### 画面切り替えのアニメーションの設定

①設定するスライドをクリックして表示します。１枚目のスライドから２枚目のスライドに移る際のアニメーション効果は、２枚目のスライドをクリックします。

{% screenshot sample1.png "設定するスライドをクリック" %}

②[画面切り替え]リボンをクリックしてアニメーション効果を表示します。

{% screenshot sample2.png "画面切り替えリボン" %}

③その他[▼]をクリックするとアニメーション効果の一覧が表示されます。好きなアニメーション効果をクリックし選択します。

{% screenshot sample3.png "アニメーション効果を選択" %}

設定が完了したスライドにはスライド左横に[★]が表示されます。

④プレビューをクリックすると画面切り替えのアニメーション効果が再生されます。
