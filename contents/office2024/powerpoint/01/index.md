...
- パワーポイント（PowerPoint2024）の基本操作ができるようになる
---
...
現在、情報処理教室の環境は、PowerPoint2024です。
実際の操作方法については、「4. Microsoft PowerPoint 2024の概要」に説明が記載されています。
...
#### 既存の文書の変更を保存する
  ...
  2. ![上書き保存](pic/pp_save2.png)をクリックします

あるいは、クイックアクセスツールバーの ![上書き保存](pic/pp_save.png)（[上書き保存]） をクリックします。
...
発表者の様子、音声を含んだスライドショーの録画を行えます。

{% screenshot pp_ribbon_record.png "リボン 記録" %}
