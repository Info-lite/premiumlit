...
purposes:
    ...
    - パワーポイント（PowerPoint2024）の主な機能（画面切り替え、アニメーション、リンク・画像の挿入）を活用できるようになる
...
Microsoft PowerPoint 2024の主な機能
-------------------
...
なお、表を挿入したい場合は、エクセル（Excel2024）で作成した表をコピーして貼り付けることができます。
...
このテーマでアイディアが浮かばない場合は、以下のテーマについて取り組んでもかまいません。
