...
まず、新 1 列目の 2 - 3 行を結合します。
  ...
  2. [テーブルレイアウト]リボン - ![セルの結合](pic/word_comb.png) をクリックします。
...
"初級編"、"中級編"の文字を縦書きにします。通常の文章と同じように選択 - [テーブルレイアウト]リボン - ![文字列の方向](pic/word_tate.png) をクリックします。

{% screenshot word02_22word.png "文字列の方向を変更" %}

#### セル内の文字配置

設定をするセルを選択 - [テーブルレイアウト]リボン - "配置"パネルから適当な配置を選びます。
...
{% screenshot word02_03table.png "列幅の変更" %}
