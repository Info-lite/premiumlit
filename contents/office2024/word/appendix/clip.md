...
&#9316; この無駄を消すために図に対する文字列の折り返し方を設定します。[図形の書式]リボン - [文字列の折り返し]をクリックします。

{% screenshot word02_clip_07clip.png "文字の折り返し一覧" %}

<dl>
<dt>行内</dt><dd>カーソルのある位置に図が挿入されます。</dd>
<dt>四角形</dt><dd>図の周囲のボックスの線に沿って文字列を折り返します。</dd>
<dt>狭く</dt><dd>通常よりも図と文章の間隔が狭くなります。</dd>
...
&#9317; 初期設定では、図は行内に配置されているので、1つの文字と同じ扱いになっています。[四角形]を選択します。

{% screenshot word02_clip_09clip.png "文字の折り返し　四角形" %}

図に沿って文字列が表示されるようになり、無駄なスペースを消すことができました。
