...
1.   "ユーザー名"：大学の教育研究用システムを利用する際のユーザー名を入力します。**学修番号の最初にある"1"を"u"に置き換えたもの**（学修番号が12345678ならば、ユーザー名はu2345678）になります。
1.   "パスワード"： 初回授業時に配布したもの、あるいは、自身で設定した場合はそちらを入力してください。
1.   "ログオン先"："SPCTMU"となっていることを確認してください。
